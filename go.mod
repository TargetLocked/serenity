...
replace (
	github.com/sagernet/sing-box => github.com/targetlocked/sing-box v0.0.0-20241022070749-b7565bd349ae
	github.com/sagernet/sing-dns => github.com/targetlocked/sing-dns v0.0.0-20241022070534-a75f2038bb46
)
